...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'menu' | 'reservation' | 'restaurant' | 'table' | 'user';
  ...
  interface tableFieldRefs {
    ...
    readonly is_reserved: FieldRef<'table', 'Boolean'>;
  ...
  export type tableWhereInput = {
    ...
    is_reserved?: BoolNullableFilter<'table'> | boolean | null;
  ...
  export type tableScalarWhereWithAggregatesInput = {
    ...
    is_reserved?: BoolNullableWithAggregatesFilter<'table'> | boolean | null;
