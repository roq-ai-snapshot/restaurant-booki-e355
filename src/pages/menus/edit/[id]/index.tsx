      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="available_from" mb="4">
            ...
            <DatePicker
              selected={formik.values?.available_from ? new Date(formik.values?.available_from) : null}
          ...
          <FormControl id="available_to" mb="4">
            ...
            <DatePicker
              selected={formik.values?.available_to ? new Date(formik.values?.available_to) : null}
