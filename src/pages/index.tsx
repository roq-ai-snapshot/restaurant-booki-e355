  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Simplifying dining experiences by enabling table reservations and menu management at your fingertips. A perfect blend of customer convenience and restaurant efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Simplifying dining experiences by enabling table reservations and menu management at your fingertips. A perfect blend of customer convenience and restaurant efficiency.`}
            </Text>
            <Box
